...
import it.csi.nembo.nembopratiche.dto.procedimentooggetto.quadrodinamico.DatoElementoQuadroDTO;
import it.csi.nembo.nembopratiche.dto.procedimentooggetto.quadrodinamico.ElementoQuadroDTO;
import it.csi.nembo.nembopratiche.dto.procedimentooggetto.quadrodinamico.VoceElementoDTO;
...
public class QuadroDinamicoUtils
{
      ...
      boolean formatForEdit)
  {
    ...
    int precisione = NemboUtils.NUMBERS.nvl(elemento.getPrecisione(), 0);
    return NemboUtils.FORMAT.formatGenericNumber(bdValore, precisione,
